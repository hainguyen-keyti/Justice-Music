...
contract Ranking is FileStruct, Ownable{
    ...
    constructor(address _fileStorageAddr) public payable{
    ...
    function getRanking(uint _TimeRanking, Kind _kind) public view returns(File[], int[]){
    ...
    function getTimeRanking() public view returns(uint[]){
