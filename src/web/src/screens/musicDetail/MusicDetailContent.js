...
class MusicDetailContent extends React.Component {
  state = {
    hashAvatar: "",
  };
              ...
              <Col span={8}>
                ...
                <Row style={{padding: 5, margin: 5}}>
                  <div className="logo-name">
                    ...
                    <Paragraph strong style={{fontSize: '25px', margin: '15px'}} ellipsis>Nói Hêt Lòng Này</Paragraph>
                  </div>
                </Row>
                <Row style={{padding: 5, margin: 5}}>
...
export default connect(mapStateToProps, mapDispatchToProps)(MusicDetailContent);
