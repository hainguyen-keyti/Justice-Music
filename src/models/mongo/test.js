...
// // request.get('http://ipfs.jumu.tk/QmUzvaqtvvnCmkTmTNRYQJsnFfi3PFFnQr6jABbgfeMSXy', async function (err, res, body222) {
// //     //process exif here
// //     console.log(err)
// //     console.log(res)
// //     console.log(body222)
...
// // // axios.get(`http://ipfs.jumu.tk/QmZimW456PmaUy5SLjfGPKxPUXmHSm7zAQoGruV9c8UD2U`)
...
// // const stream = fs.createReadStream('http://ipfs.jumu.tk/QmZimW456PmaUy5SLjfGPKxPUXmHSm7zAQoGruV9c8UD2U');
...
// //   const stream = request('http://ipfs.jumu.tk/QmZimW456PmaUy5SLjfGPKxPUXmHSm7zAQoGruV9c8UD2U').pipe(fs.createWriteStream('song.mp3'))
// //   console.log("hihi")
// //   setTimeout(function(){ 
// // form.append('audio', stream);
// request.get('http://ipfs.jumu.tk/Qme5uQmftCgJ1ViYKPRov8wCKWH2A2oohywUSa9vJgBPzC', async function (err, res, body222) {
//     //process exif here
...
// // })
const arr = new Array(2,3,7,5,3,8,7,8)
const numb = 10
function test(arr, numb) {
  let arrTemp = new Array()
  for(let i = 0; i < arr.length; i++){
    for(let j = i + 1; j < arr.length; j++ ){
      if(arr[i] + arr[j] == numb){
        if(!(arrTemp.indexOf(i) > 0 || arrTemp.indexOf(j) > 0)){
          arrTemp.push(i)
          arrTemp.push(j)
          console.log(`${i}[${arr[i]}] and ${j}[${arr[j]}]`)
          break
        }
      }
    }
